        ...
        {folders.map((folder) => {
          ...
          return (
            <button
              ...
              className="group absolute cursor-pointer rounded-xl outline-none transition-all duration-300 focus-visible:ring-4 focus-visible:ring-primary/60"
              style={folder.box}
            >
              {/* glow / light-up layer */}
              <span
